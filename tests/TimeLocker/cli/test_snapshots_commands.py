...
from .test_utils import runner, combined_output, assert_success, create_mock_cli_service_manager
...
class TestSnapshotsCommands:
    ...
    @pytest.mark.unit
    @patch('TimeLocker.cli_modules.commands.snapshots._get_service_manager_for_command')
