...
class TestPathOperations:
    ...
    def test_add_exclude_path(self, selection, test_dir):
    ...
    def test_remove_path(self, selection, test_dir):
...
class TestPatternOperations:
    ...
    def test_pattern_group_exclusion(self, selection):
...
class TestPatternGroups:
    def test_add_common_pattern_group(self, selection):
    ...
    def test_add_custom_pattern_group(self, selection):
    ...
    def test_remove_pattern_group(self, selection):
