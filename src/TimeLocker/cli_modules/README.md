...
See [CLI Refactoring Plan](../../../docs/guides/cli-refactoring-plan.md) for details.
...
- [CLI Refactoring Plan](../../../docs/guides/cli-refactoring-plan.md)
- [Phase 1 Implementation](../../../docs/updates/2025-11-07-cli-refactoring-phase1.md)
