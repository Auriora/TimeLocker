...
class CommandBuilder:
    ...
    def param(self, name: str, value: Union[str, List[str]] = None) -> 'CommandBuilder':
        ...
        if param_def.value_required and value is None and param_def.style not in [ParameterStyle.DOUBLE_DASH, ParameterStyle.SINGLE_DASH]:
    ...
    def build(self, synopsis_values: Dict[str, str] = None, use_short_form: bool = False) -> List[str]:
        ...
        for name, value in self.params.items():
            ...
            param_name = param_def.short_name if use_short_form and param_def.short_name else name
            param_style = param_def.short_style if use_short_form and param_def.short_style else param_def.style
            param_prefix = "-" if param_style == ParameterStyle.SINGLE_DASH else param_def.prefix
            ...
            if param_style == ParameterStyle.DOUBLE_DASH:
                ...
                prefix = "-" if use_short_form and param_def.short_name else param_prefix
