...
This diagram illustrates the layered architecture of TimeLocker, showing how user interfaces interact with core services, which in turn utilize the
infrastructure layer to perform operations on various storage backends.