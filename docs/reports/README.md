...
**When to use this template**: This directory contains data-driven, point-in-time snapshots of project health. These reports are often generated by automated
tools as part of a CI/CD pipeline.
