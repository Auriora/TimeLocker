...
**When to use this template**: This folder holds documents that link project artifacts together to ensure completeness and provide an audit trail. For example,
a traceability matrix can connect requirements to the design decisions, code, and tests that satisfy them.
