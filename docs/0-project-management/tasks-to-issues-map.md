...
|   #16 | Docs: Audit and update README and INSTALLATION for v1.0.0                   | docs/archive/final-status-report.md#L148-L152; docs/guides/user/installation.md        |
...
|   #25 | Testing: Verify installation on clean environments                          | docs/final-status-report.md#L160-L166; docs/guides/user/installation.md                |
