...
|---------|-------|--------------|--------|-------------------|----------------|----------------|----------------------|--------------|
| 001-cli-consolidation-stabilization | CLI Consolidation Stabilization | removed; recover from Git | removed | `a1bb654` | pending | removed | `docs/3-implementation/service-layer-integration.md`; `docs/reference/repo-orientation-and-change-map.md`; `docs/specs/README.md`; `docs/history/` | `docs/history/spec-closure-log.md` |
