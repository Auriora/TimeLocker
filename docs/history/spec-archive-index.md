...
|---------|-------|--------------|--------|-------------------|----------------|----------------|----------------------|--------------|
| 004-repository-hygiene | Repository Hygiene | removed; recover from Git | removed | `52e5a59` | pending metadata follow-up | removed | `AGENTS.md`; `README.md`; `CHANGELOG.md`; `docs/guides/ai-agent/`; `docs/resources/`; `docs/templates/`; `docs/specs/001-cli-consolidation-stabilization/` | `docs/history/spec-closure-log.md` |
