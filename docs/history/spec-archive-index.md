...
|---------|-------|--------------|--------|-------------------|----------------|----------------|----------------------|--------------|
| 005-project-charter | Project Charter | removed; recover from Git | removed | `ad96064` | pending metadata follow-up | removed | `CHARTER.md`; `README.md`; `docs/README.md`; `AGENTS.md`; `docs/specs/README.md`; `docs/specs/001-cli-consolidation-stabilization/requirements.md` | `docs/history/spec-closure-log.md` |
