...
|---------|-------|--------------|--------|-------------------|----------------|----------------|----------------------|--------------|
| 002-prune-historical-documentation | Prune Historical Documentation | removed; recover from Git | removed | `0d10228` | pending | removed | `docs/README.md`; `docs/DOCUMENTATION-STATUS.md`; `docs/guides/ai-agent/`; `docs/history/` | `docs/history/spec-closure-log.md` |
