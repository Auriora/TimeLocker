...
- [x] 13. Implement BackupCLIHandler for data selection integration
...
- [x] 14. Update backup CLI commands to use data selections
...
- [x] 15. Fix CLI help text and documentation
